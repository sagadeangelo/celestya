...
class CelestyaColors {
  ...
  static const starlightGold =
      Color(0xFFFFD700); // Calidez, destino, luz de estrellas
  static const mysticalPurple =
      Color(0xFF7B2CBF); // Profundidad, misterio, espiritualidad
  static const celestialBlue = Color(0xFF3A86FF); // Confianza, cielo despejado

  // Backgrounds (Night Sky System)
  static const spaceBlack =
      Color(0xFF030308); // El vacío del espacio (fondo principal dark)
  ...
  static const cosmicCream = Color(0xFFFFFDF9); // Máxima sutileza, casi blanco
  static const softSand = Color(0xFFFFFBF2); // Arena ultra pálida
  ...
  static const starDust =
      Color(0xFFE0AAFF); // Polvo de estrellas (acentos sutiles)
  ...
  static const LinearGradient softSpaceGradient = LinearGradient(
    colors: [
      Color(0xFF4A3080),
      Color(0xFF1F1B3E)
    ], // Medium Purple -> Dark Cosmic Purple
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );
...
class AppTheme {
  ...
  static ThemeData get light {
    ...
    return base.copyWith(
      ...
      textTheme:
          CelestyaTextStyles.createTextTheme(CelestyaColors.textPrimaryLight),
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle:
            CelestyaTextStyles.titleLarge(CelestyaColors.textPrimaryLight),
      ),
  ...
  static ThemeData get dark {
    ...
    final colorScheme = ColorScheme.fromSeed(
      ...
      brightness: Brightness.dark,
      primary:
          CelestyaColors.mysticalPurple, // O starlightGold para más contraste
      secondary: CelestyaColors.nebulaPink,
      tertiary: CelestyaColors.auroraTeal,
    ...
    return base.copyWith(
      ...
      // Tipografía personalizada con Inter
      textTheme:
          CelestyaTextStyles.createTextTheme(CelestyaColors.textPrimaryDark),
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle:
            CelestyaTextStyles.titleLarge(CelestyaColors.textPrimaryDark),
      ),
      filledButtonTheme: FilledButtonThemeData(
        style: FilledButton.styleFrom(
          padding: const EdgeInsets.symmetric(vertical: 14, horizontal: 20),
